...
from task3.views import task3_func_view
from task3.views import task3_shop_view
from task3.views import skate_list
from task3.views import task3_description_view
...
urlpatterns = [
    ...
    path('skate_list/', skate_list, name='skate_list'),
